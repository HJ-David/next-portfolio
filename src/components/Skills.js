...
const Skills = () => {
  return (
    <>
      <h2 className='font-bold text-6xl mt-64 w-full text-center md:text-4xl md:mt-32'>
        Skills
      </h2>
      <div
      ...
      >
        ...
        <Skill name='Headless CMS' x='-25vw' y='18vw' />
